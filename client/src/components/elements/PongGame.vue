  ...
  <div>
    <div v-if="this.isYou != null" class="playerinfo">
      <div class="players-container">
        <div class="profile left-profile">
          ...
          <p>
            Wins: {{ this.leftPlayerwin }} Losses: {{ this.leftPlayerloss }}
          </p>
        </div>
        <div
          v-if="
            this.$route.query.startTournament ||
            this.$route.query.joinTournament
          "
          class="profile right-profile"
        >
          Round: {{ this.round }}
        </div>
        <div class="profile right-profile">
          ...
          <p>
            Wins: {{ this.rightPlayerwin }} Losses: {{ this.rightPlayerloss }}
          </p>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <div
        class="ball"
        :style="{
          top: ballPosition.yaxis + 'px',
          left: ballPosition.xaxis + 'px',
        }"
      ></div>
      <div
        class="start-button"
...
export default {
  ...
  methods: {
    ...
    handleWebSocketMessage(message) {
      ...
      if (parts[0] == "MATCH") {
        if (this.matchreset == true) this.games = [];
      ...
      if (parts[0] == "SCR") {
        ...
        if (
          (rest[0] > this.leftScore && this.isYou == true) ||
    ...
    async updatePaddleColors() {
      const playerPaddle =
        this.$refs.gameContainer.querySelector(".rightPaddle");
      ...
      if (this.isYou) {
        ...
        enemyPaddle.style.boxShadow =
          "0 0 10px yellow, 0 0 20px yellow, 0 0 30px yellow";
