<template>
	...
	methods: {
		...
		async update_user() {
		try {
			const response = await axios.post('/api/user', this.updateUser, {
			withCredentials: true,
			});
			this.data = response.data;
		} catch (error) {
		...
		try {
			...
			const response = await axios.post('/api/room/create', this.newRoom, {
			withCredentials: true,
			});
			this.data = response.data;
		} catch (error) {
		...
		try {
			const url = `/api/room/create/personal/${this.partnerId}`;
		...
		try {
			...
			const response = await axios.post('/api/room/update', this.updateRoomData, {
			withCredentials: true,
			});
		...
		async list_room() {
		try {
			const url = `/api/room/list/${this.listRoomId}`;
		...
		async join_room() {
		try {
			const url = `/api/room/join/${this.createRoomId}`;
			const response = await axios.post(url, null, {
			withCredentials: true,
			});
			this.data = response.data;
		...
		async part_room() {
		try {
			const url = `/api/room/part/${this.partRoomId}`;
			const response = await axios.post(url, null, {
			withCredentials: true,
			});
			this.data = response.data;
		...
		async messages_room() {
		try {
			const url = `/api/room/messages/${this.messageRoomId}`;
			const response = await axios.get(url, null, {
			withCredentials: true,
			});
			this.data = response.data;
